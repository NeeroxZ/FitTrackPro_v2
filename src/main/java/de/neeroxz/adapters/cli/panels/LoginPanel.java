...
import de.neeroxz.adapters.cli.validation.UserInputValidator;

import java.util.Scanner;

public class LoginPanel extends AbstractConsolePanel {
    private final AuthenticationUserUseCase authenticationService;
    private final Scanner scanner = new Scanner(System.in); //todo
    private final UserInputValidator validator;

    public LoginPanel(AuthenticationUserUseCase authenticationService)
    {
